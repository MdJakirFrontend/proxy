...
const Hero = () => {
  return (
    <section className='hero-banner bg-cover bg-center object-cover object-center pb-16 md:pb-28 lg:pb-48 xl:pb-60 pt-60 relative' style={{ backgroundImage: `url(${heroBanner.src})` }}>
      <div className='container md:px-10 lg:px-32 flex items-end'>
        <div className='md:w-8/12 xl:w-5/12'>
          ...
          <Typography Tag='p' variant='p' className='text-'>
