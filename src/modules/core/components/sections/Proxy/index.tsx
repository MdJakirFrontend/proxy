...
const ProxyGuide = () => {
    return (
        <section className='bg-cover bg-center object-cover object-center py-20 relative' style={{ backgroundImage: `url(${proxyBanner.src})` }}>
            <div className='container px-20'>
                <div className='w-6/12'>
                    <Typography Tag='h2' variant='sectitleWhite' className='sectitleWhite mb-4'>
                        Looking for proxies from various countries?
                    </Typography>
                    <Typography Tag='p' className='infoText mb-6'>
                    ...
                    <Button className='mb-6'>buy proxies from trusted sellers</Button>
                </div>
            </div>
        </section>
    );
