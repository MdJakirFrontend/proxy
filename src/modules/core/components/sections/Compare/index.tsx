            ...
            <div className="container">
                ...
                <div className='md:w-10/12 mx-auto'>
                    <div className='lg:flex items-center justify-between'>
                        <div className='lg:w-5/12 bg-cover bg-center object-cover object-cente p-16 rounded-[2.5rem] relative mb-8 lg:mb-0'>
                        ...
                        <div className='lg:w-2/12 mb-8 lg:mb-0'>
                            <Typography Tag='h1' variant='title' className='text-5xxl text-center'>
                                VS
                            </Typography>
                        </div>
                        <div className='lg:w-5/12 bg-cover bg-center object-cover object-cente p-16 rounded-[2.5rem] relative'>
